...
- (void)changeVideo:(UIButton *)sender {
    NSString *URLString = @"http://www.exit109.com/~dnn/clips/RW20seconds_1.mp4";
...
- (ZFPlayerControlView *)controlView {
    if (!_controlView) {
        ...
        //设置竖直方向的toptoolview的hidden就可以隐藏普通模式的标题
        _controlView.portraitControlView.topToolView.hidden = true;
    }
    return _controlView;
}
